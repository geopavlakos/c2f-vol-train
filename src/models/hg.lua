...
function createModel()
	...
	if opt.nStack > 1 then
	    tmpOut = nnlib.SpatialConvolution(opt.nFeats,outputDim[i][1],1,1,1,1,0,0)(ll)
	else
            tmpOut = nnlib.SpatialConvolution(opt.nFeats,outputDim[1],1,1,1,1,0,0)(ll)
	end
        ...
        if i < opt.nStack then
            ...
            local tmpOut_ = nnlib.SpatialConvolution(outputDim[i][1],opt.nFeats,1,1,1,1,0,0)(tmpOut)
